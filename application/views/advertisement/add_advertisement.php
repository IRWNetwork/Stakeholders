						...
						<form class="bs-example form-horizontal" name="frm" method="post" enctype="multipart/form-data">
							<div class="col-md-12">
								<div class="form-group" id="add_name">
									...
									<div class="col-sm-6">
										<input type="text" name="add_name" class="form-control" value="<?php if(isset($contentRow['add_name'])){ echo $contentRow['add_name']; }?>" />
									</div>
								</div>
								<div class="form-group" id="add_name">
									<label class="col-sm-3 control-label">Add Link</label>
									<div class="col-sm-6">
										<input type="text" name="add_link" class="form-control" value="<?php if(isset($contentRow['add_link'])){ echo $contentRow['add_link']; }?>" />
									</div>
								</div>
