	...
	<div class="bg-info">
		<div class="container">
			<div class="row m-t-xl m-b-xl">
				...
				<div class="col-sm-6 text-center"> <a href="http://themeforest.net/item/angulr-bootstrap-admin-web-app-with-angularjs/8437259?ref=flatfull" class="btn btn-lg btn-default btn-rounded">Get Angulr Now</a> </div>
			</div>
		</div>
	</div>
	<div class="bg-white">
		<div class="container">
			<div class="row m-t-xl m-b-xl">
				<div class="col-sm-3">
					<h4 class="text-u-c m-b font-thin"><span class="b-b b-dark font-bold">Information</span></h4>
					<ul class="list-unstyled">
						<li><a href="#"><i class="fa fa-angle-right m-r-sm"></i>West Coast</a></li>
						<li><a href="#"><i class="fa fa-angle-right m-r-sm"></i>Central US</a></li>
						<li><a href="#"><i class="fa fa-angle-right m-r-sm"></i>East Coast</a></li>
						<li><a href="#"><i class="fa fa-angle-right m-r-sm"></i>Canada</a></li>
					</ul>
	...
	<div class="bg-light dk">
		<div class="container">
			<div class="row padder-v m-t">
				...
				<div class="col-xs-4 text-right"> Angulr &copy; 2015 </div>
			</div>
		</div>
	</div>
</footer>