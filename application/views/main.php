			...
			<div class="col-xs-6 col-sm-4 col-md-4 field" data-fullText="<?php echo $row->title?>">
				<div class="item">
					<div class="pos-rlt">
						...
						<a href="<?php echo $url;?>" class="playSong" data-title="<?php echo $row->title?>" data-song='<?php echo $row->file?>' data-id='<?php echo $row->id?>'><img src="<?php echo base_url()?>uploads/featured/<?php echo $row->picture?>" alt="" class="img-full r r-2x" ></a>
					</div>
			...
			<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2-4 field float_none" >
				<div class="item">
					<div class="pos-rlt">
						...
						<a href="<?php echo $url;?>" class="playSong" data-image="<?php echo $row->picture; ?>" data-title="<?php echo $row->title?>" data-song='<?php echo $row->file?>' data-id='<?php echo $row->id?>'><img src="<?php echo base_url()?>uploads/listing/<?php echo $row->picture?>" alt="" class="img-full r r-2x" ></a> </div>
