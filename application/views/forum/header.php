...
<html lang="en">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/resources/bootstrap/css/bootstrap.min.css"/>
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/resources/bootstrap/css/bootstrap-responsive.min.css"/>
    <script src="<?php echo base_url(); ?>assets/resources/bootstrap/js/jquery-1.7.2.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/resources/bootstrap/js/bootstrap.min.js"></script>
    </head>
    <body>            
        <div class="container-fluid">
            ...
            <div class="navbar" id="nav">
                ...
                <div class="container">
                    ...
                    <ul class="nav">
                        <li><a href="<?php echo site_url('forum/thread/index'); ?>">Home</a></li>
                        <script>
                        $(function() {
