							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-lg-6">
                                        ...
                                        <span id="remaning_title_character">100</span> Character
									</div>
								</div>
								<div class="form-group">
                                ...
                                <div class="form-group">
									...
									<div class="col-lg-9">
										<textarea name="description" id="description" class="form-control" placeholder="Give detail of video"><?php if(isset($contentRow['description'])){ echo $contentRow['description']; }?></textarea>
									</div>
								</div>
                                <div class="form-group">
