                    ...
                    <form id="package_form" name="frm" method="post" class="form-horizontal form-label-left">
						<div class="item form-group">
                        	...
                        	<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<script type="text/javascript">
									document.frm.type.value='<?php echo $this->input->post('type')?>';
								</script>
								<?php }?>
                        	</div>
                      	</div>
						<div class="item form-group">
                        	...
                        	<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<?php if($this->input->post('message_type')){?>
								<script type="text/javascript">
									document.frm.message_type.value='<?php echo $this->input->post('message_type')?>';
								</script>
								<?php }?>
                        	</div>
                      	</div>
						<div class="item form-group">
                        	...
                        	<div class="col-md-6 col-sm-6 col-xs-12">
                          		<input id="caption" value="<?php if($this->input->post('caption')){ echo $this->input->post('caption');}?>"  name="caption" class="form-control col-md-7 col-xs-12"  type="text">
                        	</div>
                      	</div>
						<div class="item form-group">
                        	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="text_price">Credits</label>
                        	<div class="col-md-6 col-sm-6 col-xs-12">
                          		<input id="credits" value="<?php if($this->input->post('credits')){ echo $this->input->post('credits');}?>" name="credits" class="form-control col-md-7 col-xs-12"  type="text">
                        	</div>
                      	</div>
						<div class="item form-group">
                        	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="video_price">Amount</label>
                        	<div class="col-md-6 col-sm-6 col-xs-12">
                          		<input id="video_price" value="<?php if($this->input->post('amount')){ echo $this->input->post('amount');}?>" name="amount" class="form-control col-md-7 col-xs-12"  type="text">
                        	</div>
                      	</div>
						<div class="item form-group">
                        	...
                        	<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<?php if($this->input->post('locked')){?>
								<script type="text/javascript">
									document.frm.locked.value='<?php echo $this->input-post('locked')?>';
								</script>
								<?php }?>
                        	</div>
                      	</div>						
