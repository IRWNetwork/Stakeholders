...
<li class="list-group-item">
    ...
    ?>
        ...
        <div class="clear text-ellipsis"><a class="m-r-sm pull-left play_list_song <?php echo $item_play; ?>" type="<?php echo $row->type; ?>" data-for="<?php echo $data_for; ?>"  href="<?php echo $my_href; ?>"><span><spanclass="badge bg-info m-l-sm m-t-sm"><?php echo $premium_label; ?></span><?php echo substr($row->title,0,35)?></span></a></div>
    <?php }else{?>
