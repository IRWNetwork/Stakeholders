...
#footer{margin-top: 301px !important;}
}
					...
					<div class="pos-rlt">
						...
						<div class="item-overlay bg-black-opacity r r-2x r r-2x" data-url='<?php echo $url; ?>'>
							<div class="center text-center m-t-n w-full dropdown">
								...
								<a href="<?php echo $url;?>" class="playSong" data-title="<?php echo $row->title?>" data-image="<?php echo $row->picture;?>" data-song='<?php echo $row->file_url?>' data-id='<?php echo $row->id?>'><i class="fa fa-2x fa-play-circle-o text-white"></i></a>
						...
						<a href="<?php echo $url;?>" class="playSong" data-title="<?php echo $row->title?>" data-song='<?php echo $row->file_url?>' data-id='<?php echo $row->id?>'><img src="<?php echo base_url()?>uploads/listing/thumb_153_<?php echo $row->picture?>" alt="" class="img-full r r-2x" ></a> </div>
	...
	<?php /*?><div class="col w-md bg-light dker b-l bg-auto no-border-xs">
		<div class="wrapper-md">
			...
			<ul class="list-group no-bg no-borders pull-in">
				...
				<li class="list-group-item"> <a href="<?php echo $url;?>" class="playSong" data-title="<?php echo $row->title?>" data-song='<?php echo $row->file_url?>' data-id='<?php echo $row->id?>'> <img src="<?php echo base_url()?>uploads/listing/<?php echo $row->picture?>" class="r" style="width:30px"> </a>
					<div class="clear">
						<div><a href="<?php echo $url;?>" class="playSong" data-title="<?php echo $row->title?>" data-song='<?php echo $row->file_url?>' data-id='<?php echo $row->id?>'><?php echo substr($row->title,0,15);?></a></div>
					</div>
				</li>
				<?php }?>
			</ul>
