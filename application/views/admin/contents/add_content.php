						...
						<form class="bs-example form-horizontal" name="frm" method="post" enctype="multipart/form-data">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<textarea name="description" class="form-control" placeholder="Give detail of video"><?php if(isset($contentRow['description'])){ echo $contentRow['description']; }?></textarea>
									</div>
								</div>
								<div class="form-group">
