                        ...
                        <div class="x_content">
                            ...
                            <form method="post" action="" id="demo-form2" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="instagram_link">Payment Status</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">

                                        <?php if($payment_status == 'yes'){ ?>
                                            <input type="checkbox" name="payment_checkbox" value="no" checked />
                                        <?php }else{ ?>
                                            <input type="checkbox" name="payment_checkbox" value="yes" />
                                        <?php } ?>
